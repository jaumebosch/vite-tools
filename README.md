...
## Installation
Just install git with `apt install git` and execute `git clone https://github.com/jaumebosch/vite-tools.git`. Then `cd vite-tools` and execute `./setup.sh`. That's all!
